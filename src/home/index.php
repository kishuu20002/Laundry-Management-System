...
<html lang="zxx">
<head>
<title>Laundry Lane - A Laundry Application for Students</title>
<!-- Meta-Tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Laundry Lane Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- //Meta-Tags -->
<!-- Custom-Stylesheet-Links -->
<!-- Bootstrap-CSS --> <link href="css1/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- Font-awesome-CSS --> <link href="css1/font-awesome.css" rel="stylesheet">
<!-- Banner-slider-CSS --> <link rel="stylesheet" type="text/css" href="css1/zoomslider.css" />
<!-- Owl-carousel-CSS --><link href="css1/owl.carousel.css" rel="stylesheet">
<!-- Index-Page-CSS --><link href="css1/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- //Custom-Stylesheet-Links -->
<!--web-fonts-->
...
<!-- header -->
	...
	<div class="w3-header-bottom">
		<div class="container"> 
				<h1><a href="index.html"><span class="letter">L</span>aundry Lane<span class="square"></span></a></h1>	
...
<!-- about -->
	<div class="about-w3layouts">
		...
		<div class="col-md-6 col-sm-6 gallery-grids2 right-w3ls-gridsa">
			<h3>The best <span>C</span>leaning <span>s</span>ervice with <span>L</span>aundry Lane</h3>
		...
		<div class="container">
			<div class="footer-row w3layouts-agile">
				<div class="col-md-3 footer-grids w3l-agileits">
					<h6><a href="index.html"><span class="f-letter">L</span>aundy Lane<span class="f-square"></span></a></h6>
				</div>
				<div class="col-md-3 footer-grids w3l-agileits">
					<h3>Address</h3>
					<p>Bhubaneswar</p>
				...
				<div class="col-md-3 footer-grids w3l-agileits">	
					<!-- <h3>Questions....?</h3> -->
					<p>+91 9162764315<p>
					<p><a href="mailto:info@example.com">Laundry Lane@example.com</a></p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<!-- copy-right -->
		<div class="copyright-wthree">
			<div class="container">
				...
				<!-- <p>&copy; 2017 Laundry Lane . All Rights Reserved | Design by <a href="http://w3layouts.com/"> W3layouts </a></p> -->
			</div>
		</div>
<!-- //copy-right -->
<!-- Modal 4 for Customer login -->
				...
				<div class="modal-body login-page "><!-- login-page -->     
									<div class="login-top sign-top">
										...
										<h5>Register</h5>
												...
												<div>
													<input type="password" id ="password" class="password" name="password" placeholder="Password" required="true"/>
													<span class="error_message" id="password_error"></span>
												</div>
												<div>
													<input type="text" id="email" class="Email" name="email" placeholder="Email" required="true"/>
													<span class="error_message" id="email_error"></span>
													<span class="error_message" id="email_error1"></span>
												</div>
												<div>
...
<script type="text/javascript" src="js1/jquery.zoomslider.min.js"></script>
